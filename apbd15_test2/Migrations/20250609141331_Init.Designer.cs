...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("apbd15_test2.Models.AvailableProgram", b =>
                {
            ...
            modelBuilder.Entity("apbd15_test2.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("apbd15_test2.Models.PurchaseHistory", b =>
                {
                    b.Property<int>("AvailableProgramId")
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            AvailableProgramId = 2,
                            CustomerId = 2,
                            PurchaseDate = new DateTime(2024, 6, 5, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Rating = 4
                        });
                });

            modelBuilder.Entity("apbd15_test2.Models.WashingMachine", b =>
                {
                    b.Property<int>("WashingMachineId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("apbd15_test2.Models.WashingProgram", b =>
                {
                    b.Property<int>("ProgramId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("apbd15_test2.Models.AvailableProgram", b =>
                {
                    b.HasOne("apbd15_test2.Models.WashingProgram", "WashingProgram")
                        .WithMany()
                        .HasForeignKey("ProgramId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("apbd15_test2.Models.WashingMachine", "WashingMachine")
                        .WithMany()
            ...
            modelBuilder.Entity("apbd15_test2.Models.PurchaseHistory", b =>
                {
                    b.HasOne("apbd15_test2.Models.AvailableProgram", "AvailableProgram")
                        .WithMany()
                        .HasForeignKey("AvailableProgramId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("apbd15_test2.Models.Customer", "Customer")
                        .WithMany()
